...
TEST(TMatrix, can_create_transformed_matrix)
{
	TVector<TVector<int> > a(5);
	for (int i = 0; i < a.GetSize(); ++i) {
		a[i] = TVector<int>(a.GetSize() - i, i);
	}
	a[0][0] = 5; a[0][1] = 7; a[0][2] = 8; a[0][3] = 3; a[0][4] = 4;
	a[1][1] = 5; a[1][2] = 7; a[1][3] = 8; a[1][4] = 3;
	a[2][2] = 5; a[2][3] = 7; a[2][4] = 8;
	a[3][3] = 5; a[3][4] = 7;
	a[4][4] = 5;

	ASSERT_NO_THROW(TMatrix<int> m1(a));
}

TEST(TMatrix, cant_create_transformed_not_triangle_matrix)
{
	TVector<TVector<int> > a(5);
	for (int i = 0; i < a.GetSize(); ++i) {
		a[i] = TVector<int>(a.GetSize(), i);
	}
	a[0][0] = 5; a[0][1] = 7; a[0][2] = 8; a[0][3] = 3; a[0][4] = 4;
	a[1][1] = 5; a[1][2] = 7; a[1][3] = 8; a[1][4] = 3;
	a[2][2] = 5; a[2][3] = 7; a[2][4] = 8;
	a[3][3] = 5; a[3][4] = 7;
	a[4][4] = 5;
	ASSERT_ANY_THROW(TMatrix<int> mtr(a));
}
...
TEST(TMatrix, assign_matrixes_of_equal_size_is_true)
{
	TMatrix<int> m1(5), m2(5);
	m1[0][0] = 5; m1[0][1] = 7; m1[0][2] = 8; m1[0][3] = 3; m1[0][4] = 4;
	m1[1][1] = 5; m1[1][2] = 7; m1[1][3] = 8; m1[1][4] = 3;
...
TEST(TMatrix, subtraction_matrixes_works_right)
{
	TMatrix<int> m1(5), m2(5), m3(5);
...
TEST(TMatrix, compare_matrix_with_itself__return_true)
{
	TMatrix<int> m(5);
...
TEST(TMatrix, compare_matrices_with_different_size_return_true)
{
	TMatrix<int> m1(5), m2(6);
...
TEST(TMatrix, can_multply_matrixes_with_equal_size)
{
	TMatrix<int> m1(5), m2(5);
	ASSERT_NO_THROW(m1 * m2);
}
...
TEST(TMatrix, multiplication_matrixes_works_right)
{
	TMatrix<int> m1(5), m2(5), m3(5);
	...
	m3[0][0] = 25; m3[0][1] = 70; m3[0][2] = 129; m3[0][3] = 142; m3[0][4] = 146;
	m3[1][1] = 25; m3[1][2] = 70; m3[1][3] = 129; m3[1][4] = 142;
	m3[2][2] = 25; m3[2][3] = 70; m3[2][4] = 129;
	m3[3][3] = 25; m3[3][4] = 70;
	m3[4][4] = 25;
